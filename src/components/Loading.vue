...
.loader:after {
  ...
  -moz-animation: shadow 1.7s infinite linear;
  bottom: 0em;
  left: 0;
  height: 0.25em;
  width: 1em;
...
.roller:last-child {
  ...
  top: 0;
  left: 0;
  -webkit-animation: rollercoaster 1.7s infinite linear;
  -webkit-transform: rotate(135deg);
  -moz-animation: rollercoaster 1.7s infinite linear;
  -moz-transform: rotate(135deg);
  animation: rollercoaster 1.7s infinite linear;
...
.roller:last-child {
  ...
  -webkit-animation: rollercoaster2 1.7s infinite linear;
  -moz-transform: rotate(-45deg);
  -moz-animation: rollercoaster2 1.7s infinite linear;
  transform: rotate(-45deg);
  animation: rollercoaster2 1.7s infinite linear;
}
